...
var chao = {
	...
	init: function(width, height) {
		...
		chao.canvas.setAttribute("width", width * dips);
		chao.canvas.setAttribute("height", height * dips);
		...
		chao.font 			= chao.loadBase64Font(defaultFontData);
