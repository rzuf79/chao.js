...
function ComponentSprite(key, frameWidth, frameHeight) {
  this.name = "Sprite"; // Name by which this component is identified.
...
function ComponentButton(image) {
  ...
  this.sprite = null; // Sprite used as this button's graphic.
  this.spritePressed = null; // Sprite used as this button's pressed state graphic.
